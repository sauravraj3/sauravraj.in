		...
		<div id="content-area" class="clearfix">
			...
			<?php while ( have_posts() ) : the_post(); ?>
				...
				<?php  } ?>
					...
					$bio = '<h3 class="author-title">Written by ' . get_the_author_link() . '</h3><p class="author-description">' . get_the_author_meta('description') . '</p>';
					if ( '' !== $avatar ) {
					    echo do_shortcode( "[author][author_image]${avatar}[/author_image]${bio}[/author]" );
					}
...
"publisher": {
    ...
    "logo": {
      "@type": "ImageObject",
      "url": "https://sauravraj.in/wp-content/uploads/2019/12/logo.png"
    }
  },
