<?php
/**
* Template Name: Homepage New Page
*/
...
<head>
    ...
    <!--  Bootstrap css file  -->
    <link rel="stylesheet" href="/wp-content/themes/Saurav_Raj_1.0/new/css2/bootstrap.min.css">

    <!--  font awesome icons  -->
    <link rel="stylesheet" href="/wp-content/themes/Saurav_Raj_1.0/new/css2/all.min.css">


    <!--  Magnific Popup css file  -->
    <link rel="stylesheet" href="/wp-content/themes/Saurav_Raj_1.0/new/vendor2/Magnific-Popup/dist/magnific-popup.css">


    <!--  Owl-carousel css file  -->
    <link rel="stylesheet" href="/wp-content/themes/Saurav_Raj_1.0/new/vendor2/owl-carousel/css/owl.carousel.min.css">
    <link rel="stylesheet" href="/wp-content/themes/Saurav_Raj_1.0/new/vendor2/owl-carousel/css/owl.theme.default.min.css">


    <!--  custom css file  -->
    <link rel="stylesheet" href="/wp-content/themes/Saurav_Raj_1.0/new/css2/style.css">

    <!--  Responsive css file  -->
    <link rel="stylesheet" href="/wp-content/themes/Saurav_Raj_1.0/new/css2/responsive.css">
...
<body>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 banner-image">
                        <img src="/wp-content/themes/Saurav_Raj_1.0/new/img2/banner/banner-image.png" alt="banner-img" class="img-fluid">
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12">
                        <div class="about-image">
                            <img src="/wp-content/themes/Saurav_Raj_1.0/new/img2/about-us.png" alt="About us" class="img-fluid">
                        </div>
                    </div>
                        ...
                        <div class="first-row row">
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="single-brand">
                                    <img src="/wp-content/themes/Saurav_Raj_1.0/new/img2/brands/logo1.png" alt="Brand-1 ">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="single-brand">
                                    <img src="/wp-content/themes/Saurav_Raj_1.0/new/img2/brands/logo2.png" alt="Brand-2 ">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="single-brand">
                                    <img src="/wp-content/themes/Saurav_Raj_1.0/new/img2/brands/logo3.png" alt="Brand-3 ">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="single-brand">
                                    <img src="/wp-content/themes/Saurav_Raj_1.0/new/img2/brands/logo4.png" alt="Brand-4">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="single-brand">
                                    <img src="/wp-content/themes/Saurav_Raj_1.0/new/img2/brands/logo5.png" alt="Brand-5 ">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="single-brand">
                                    <img src="/wp-content/themes/Saurav_Raj_1.0/new/img2/brands/logo6.png" alt="Brand-6">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="single-brand">
                                    <img src="/wp-content/themes/Saurav_Raj_1.0/new/img2/brands/logo7.png" alt="Brand-7 ">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="single-brand">
                                    <img src="/wp-content/themes/Saurav_Raj_1.0/new/img2/brands/logo8.png" alt="Brand-8 ">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="single-brand">
                                    <img src="/wp-content/themes/Saurav_Raj_1.0/new/img2/brands/logo9.png" alt="Brand-9">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!--  Jquery js file  -->
    <script src="/wp-content/themes/Saurav_Raj_1.0/new/js2/jquery.3.4.1.js"></script>

    <!--  Bootstrap js file  -->
    <script src="/wp-content/themes/Saurav_Raj_1.0/new/js2/bootstrap.min.js"></script>

    <!--  isotope js library  -->
    <script src="/wp-content/themes/Saurav_Raj_1.0/new/vendor2/isotope/isotope.min.js"></script>

    <!--  Magnific popup script file  -->
    <script src="/wp-content/themes/Saurav_Raj_1.0/new/vendor/Magnific-Popup/dist/jquery.magnific-popup.min.js"></script>

    <!--  Owl-carousel js file  -->
    <script src="/wp-content/themes/Saurav_Raj_1.0/new/vendor2/owl-carousel/js/owl.carousel.min.js"></script>

    <!--  custom js file  -->
    <script src="/wp-content/themes/Saurav_Raj_1.0/new/js2/main.js"></script>
