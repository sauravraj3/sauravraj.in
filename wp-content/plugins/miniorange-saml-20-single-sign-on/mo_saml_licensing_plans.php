    ...
    <div class="tab-pane active text-center" id="cloud">
        ...
        <div class="cd-pricing-container cd-has-margins"><br>
            ...
            <div style="background: #F2F5FB;border-radius:5px;font-size: large;margin-top:10px;padding:10px;border-style: solid;border-color: #2f6062">
                    ...
                    License required for the plugin is calculated as number of instances(domains) where the plugin is
                    installed. If you have dev-staging-prod type of environment then you will require 3 licenses of the plugin.
                </div>
            <script>
            ...
            <ul id="list-type" class="cd-pricing-list cd-bounce-invert" >
                    ...
                    <ul class="cd-pricing-wrapper">
                        <li data-type="singlesite" class="mosslp is-visible" style="border: <?php echo $sssborder; ?>">
                            ...
                            <header class="cd-pricing-header">
                                ...
                                <h3 class="subheading_plans" style="color:black;">Auto-Redirect to IdP<br /><br /></h3>
                                <div class="cd-price" >
                            ...
                            <div class="cd-pricing-body">
                                <ul class="cd-pricing-features">
                                    ...
                                    <li>&nbsp;</li>
                                    <li>&nbsp;</li>
                                    <li>&nbsp;<b>Add-Ons</b><br />Purchase Separately<br /><a style="color:blue;" target="_blank" href="https://www.miniorange.com/contact"><b>Contact us</b></a><br />&nbsp;<br />&nbsp;<br />&nbsp;<br />&nbsp;<br />&nbsp;<br />&nbsp;<br />&nbsp;</li>
                        ...
                        <li data-type="multisite" class="momslp is-hidden" style="border: <?php echo $mspborder; ?>">
                            ...
                            <header class="cd-pricing-header">
                                ...
                                <h3 class="subheading_plans" style="color:black;">Auto-Redirect to IdP<br>Attribute and Role Management<br>Connect all
                                                            subsites to same IdP<br>Single Logout</h3>
                                <div class="cd-price" >
                                    <span class="cd-currency">$</span>
                    ...
                    <ul class="cd-pricing-wrapper">
                        <li data-type="singlesite" class="mosslp is-visible" style="border: <?php echo $sspborder; ?>">
                            ...
                            <header class="cd-pricing-header">
                                ...
                                <h3 class="subheading_plans" style="color:black">Attribute & Role Management<br>Single Logout<br /><br /></h3>
                        ...
                        <li data-type="multisite" class="momslp is-hidden" style="border: <?php echo $mseborder; ?>">
                            <a id="popover4" data-toggle="popover" title="<h3>Why should I choose this plan?</h3>" data-placement="top" data-html="true"
                               data-content="<p>Choose this plan if you have Multisite Network installation and are looking for features like <br /><b>Mu Domain Mapping Support<br>Easy migration from staging to prod<br>Setup SSO with multiple IdPs<br /><b>Subsite Specific SSO<br />Auto-Redirect to IdP<br />Advance Attribute Mapping<br />Role Mapping<br />IdP metadata sync<br />Support of custom SP and IdP certificate</b></p>">
                            <header class="cd-pricing-header">

                                <h2 style="margin-bottom: 10px">Enterprise</h2>

                                <h3 class="subheading_plans" style="color:black;">Mu Domain Mapping Support<br>Easy migration from staging to prod<br>Setup SSO with multiple IdPs</h3>
                                <div class="cd-price" >
                                    <span class="cd-currency">$</span>
                            ...
                            <footer class="cd-pricing-footer">
                                <a href="#" class="cd-select" onclick="upgradeform('wp_saml_sso_multisite_multiple_idp_plan')" >Upgrade Now</a>
                            </footer>
                            ...
                            <div class="cd-pricing-body">
                                <ul class="cd-pricing-features">
                                    ...
                                    <li>&nbsp;</li>
                                    <li>&nbsp;</li>
                                    <li>&nbsp;<b>Add-Ons</b><br/> SSO Login Audit<br />Purchase Separately (Remaining)<br /><a style="color:blue;" target="_blank" href="https://www.miniorange.com/contact"><b>Contact us</b></a>&nbsp;<br />&nbsp;<br />&nbsp;<br />&nbsp;<br />&nbsp;<br />&nbsp;<br />&nbsp;</li>
                ...
                <li>
                    <ul class="cd-pricing-wrapper">
                        <li data-type="singlesite" class="mosslp is-visible" style="border: <?php echo $sseborder; ?>">
                            ...
                            <header class="cd-pricing-header">
                                <h2 style="margin-bottom:10px;">Enterprise</h2>
                                <h3 class="subheading_plans" style="color:black;">Easy migration from dev to prod<br>Multiple IdP Support<br>SSO Login Audit<br /></h3>
                                <div class="cd-price" >
                                    <span class="cd-currency">$</span>
                                    <span class="cd-value">549*</span></span>
                            ...
                            <footer class="cd-pricing-footer">
                                <a href="#" class="cd-select" onclick="upgradeform('wp_saml_sso_multiple_idp_plan')" >Upgrade Now</a>
                            </footer>
                            ...
                            <div class="cd-pricing-body">
                                <ul class="cd-pricing-features ">
                                    ...
                                    <li>Custom SP Certificate</li>
                                    <li>Multiple IdP Support</li>
                                    <li style="height:80px">Compatible with multiple environments in a hosting provider like Pantheon, WP-Engine, Wordpress VIP</li>
                                    <li>&nbsp;</li>
                                    <li>&nbsp;</li>
                                    <li>&nbsp;<b>Add-Ons</b><br/> SSO Login Audit<br />Purchase Separately (Remaining)<br /><a style="color:blue;" target="_blank" href="https://www.miniorange.com/contact"><b>Contact us</b></a><br />&nbsp;<br />&nbsp;<br />&nbsp;<br />&nbsp;<br />&nbsp;<br />&nbsp;</li>
                        ...
                        <li data-type="multisite" class="momslp is-hidden" style="border: <?php echo $msbborder; ?>">
                            <a id="popover5" data-toggle="popover" title="<h3>Why should I choose this plan?</h3>" data-placement="top" data-html="true"
                               data-content="<p>Choose this plan if you are looking for <br /><b>All exclusive features included<br />Add-ons (Page Restriction, BuddyPress Attribute Mapping, LearnDash Attribute Mapping, Media Restriction, Attribute based Redirection, Federation SSO, SCIM-User Provisioning, SSO Session Management, SSO Login Audit,).</b><br /><span style='color:red;'><b>Note:</b></span> All the Add-ons are packaged with this plan. All features of all the Multisite Plans are included here.</p>">
                            <header class="cd-pricing-header">
                                <h2 style="margin-bottom:10px;">All-Inclusive</h2>
                                <h3 class="subheading_plans" style="color:black;">Multisite Network SSO with all features and all the Add-ons<br /><br /></h3>
                                <div class="cd-price" >
                                    <span class="cd-currency">$</span>
                            ...
                            <footer class="cd-pricing-footer">
                                <a href="#" class="cd-select" onclick="upgradeform('wp_saml_sso_multisite_all_inclusive_plan')" >Upgrade Now</a>
                            </footer>
                            <b style="color: coral;">See the multisite All-Inclusive Plan features list below</b>
                            <div class="cd-pricing-body">
                                <ul class="cd-pricing-features">
                                    <li>Unlimited Authentications</li>
                                    <li>Basic Attribute Mapping (Username, Email, First Name, Last Name,Display Name)</li>
                                    ...
                                    <li>Multiple IdP Support</li>
                                    <li>Compatible with multiple environments in a hosting provider like Pantheon, WP-Engine, Wordpress VIP</li>
                                    <li>Customize the metadata contact information</li>
                                    <li>Configuring plugin using APIs</li>
                                    <li><b>Add-Ons</b><br />
                                        1. Page Restriction Add-On<br />
                                        2. Buddypress Attribute Mapping Add-On<br />
                                        3. LearnDash Attribute Integration Add-On<br />
                                        4. Media Restriction Add-On<br/>
                                        5. Attribute based Redirection<br/>
                                        6. Federation SSO Add-On<br/>
                                        7. SCIM-User Provisioning<br/>
                                        8. SSO Session Management<br/>
                                        9. SSO Login Audit<br/>
                ...
                <li class="cd-popular">
                    <ul class="cd-pricing-wrapper">
                        <li data-type="singlesite" class="mosslp is-visible" style="border: <?php echo $sseborder; ?>">
                            <a id="popover6" data-toggle="popover" title="<h3>Why should I choose this plan?</h3>" data-placement="top" data-html="true"
                               data-content="<p>Choose this plan if you are looking for <br /><b>All exclusive features included<br />Add-ons (Page Restriction, BuddyPress Attribute Mapping, LearnDash Attribute Mapping, Media Restriction, Attribute based Redirection, Federation SSO, SCIM-User Provisioning, SSO Session Management, SSO Login Audit,).</b><br /><span style='color:red;'><b>Note:</b></span> All the Add-ons are packaged with this plan. All features of all the Plans are included here.</p>">
                            <header class="cd-pricing-header">
                                <h2 style="margin-bottom:10px;">All-Inclusive</h2>
                                <h3 class="subheading_plans" style="color:black;">All features along <br>with all Add-ons<br /><br /></h3>
                                <div class="cd-price" >
                                    <span class="cd-currency">$</span>
                            ...
                            <footer class="cd-pricing-footer">
                                <a href="#" class="cd-select" onclick="upgradeform('wp_saml_sso_all_inclusive_plan')" >Upgrade Now</a>
                            </footer>
                            <b >See the All-inclusive Plugin features list below</b>
                            <div class="cd-pricing-body">
                                <ul class="cd-pricing-features ">
                                    <li>Unlimited Authentications</li>
                                    <li>Basic Attribute Mapping (Username, Email, First Name, Last Name,Display Name)</li>
